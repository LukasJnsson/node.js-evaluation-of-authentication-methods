...
export default {
   ...
   * @param {String} userCred user credentials
   * @returns {Object} id and username of user
   */
  async signIn(userCred) {
     ...
     * https://developer.mozilla.org/en-US/docs/Web/API/Web_Authentication_API
     */
    const base64 = userCred.replace(/-/g, '+').replace(/_/g, '/');
    const id = Uint8Array.from(atob(base64), c => c.charCodeAt(0));
